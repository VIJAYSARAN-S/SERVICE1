...
export default function ServiceCard({
  ...
  const CardContent = (
    <div className={`group relative flex flex-col h-full gap-6 rounded-[32px] border bg-white p-8 transition-all duration-500 ${
      isActive 
      ...
      {isActive && (
        <div className="absolute top-6 right-6 text-amber">
