  ...
  return (
    <div className="mx-auto max-w-4xl pb-20">
      <div className="mb-12 text-center">
        ...
        <h1 className="text-5xl font-black tracking-tighter text-navy uppercase leading-none">Register for Voter ID</h1>
        <p className="mt-4 text-sm font-medium text-slate-400">Official application for the National Voter Identity Card.</p>
        ...
        <div className="mt-10 flex items-center gap-5 rounded-2xl bg-amber/5 border border-amber/10 p-5 text-xs text-navy text-left mx-auto max-w-3xl">
          ...
          <p className="font-bold leading-relaxed">
            <span className="text-amber-600 uppercase tracking-widest mr-2 font-black">Eligibility:</span>
            Application requires being 18 years or older. Your data will be verified against official records.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
            ...
            <section className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                   <label className="block text-xs font-bold uppercase tracking-wider text-muted mb-2">Age Verification*</label>
                   <div className="flex items-center gap-3 py-3">
                      <input type="checkbox" checked={isAgeConfirmed} onChange={handleChange} className="h-5 w-5 rounded border-slate-300 text-navy focus:ring-navy cursor-pointer" />
                      <span className="text-xs font-bold uppercase tracking-widest text-navy">I affirm I am 18+ years of age</span>
                   </div>
                </div>
                <div>
            ...
            <section className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  <label className="block text-xs font-bold uppercase tracking-wider text-muted mb-2">Constituency*</label>
                  <input type="text" name="constituency" value={formData.constituency} onChange={handleChange} placeholder="Assigned Zone" className="w-full rounded-xl border border-slate-200 bg-background px-4 py-3 text-sm text-navy focus:border-amber focus:outline-none transition-all" />
                </div>
              </div>
            </section>
            ...
            <section className="space-y-8">
              <div className="flex items-center gap-4 border-b border-slate-100 pb-4">
                ...
                <h2 className="text-xs font-black text-navy uppercase tracking-[0.2em]">Guardian & Declaration</h2>
              </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-muted mb-2">Guardian / Spouse Name*</label>
                  <input type="text" name="guardian_name" required value={formData.guardian_name} onChange={handleChange} className="w-full rounded-xl border border-slate-200 bg-background px-4 py-3 text-sm text-navy focus:border-amber focus:outline-none transition-all" />
                </div>
                <div>
