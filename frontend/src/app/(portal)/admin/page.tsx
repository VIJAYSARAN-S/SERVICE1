...
export default function AdminDashboard() {
  ...
  const appColumns = [
    ...
    { header: 'Status', accessor: 'status', render: (val: string) => {
      ...
      return (
        <span className={`rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-widest border ${map[val] || 'bg-slate-50 text-slate-400 border-slate-100'}`}>
          {val}
        </span>
      );
    }},
    { header: 'Verification Score', accessor: 'integrity_score', render: (val: number) => (
      <div className="flex items-center gap-3">
  ...
  return (
    <div className="space-y-8 pb-20">
      <div className="flex flex-col gap-2">
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-600">Global Administration</p>
        <h1 className="text-4xl font-black tracking-tighter text-navy uppercase leading-none">Admin Dashboard</h1>
        <p className="text-sm font-medium text-slate-400">System-wide monitoring and audit logs.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-8">
            <div className="rounded-[24px] border border-slate-100 bg-white shadow-soft overflow-hidden">
                <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 px-8 py-5">
                    <h3 className="text-[10px] font-black text-navy uppercase tracking-widest">Login Activity</h3>
            ...
            <div className="rounded-xl border border-border bg-white shadow-soft overflow-hidden">
                <div className="flex items-center justify-between border-b border-border bg-white/50 px-6 py-4">
                    <h3 className="text-sm font-bold text-navy uppercase tracking-wider">System Audit Logs</h3>
