    ...
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center p-4 bg-slate-50">
      <div className="w-full max-w-md overflow-hidden rounded-[32px] border border-border bg-white shadow-[0_40px_80px_-20px_rgba(15,23,42,0.15)]">
        <div className="bg-[#0F172A] p-12 text-center relative overflow-hidden">
          ...
          <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-2xl relative z-10 ring-8 ring-blue-600/10">
            <svg className="h-10 w-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <h1 className="text-3xl font-black text-white tracking-tighter relative z-10 uppercase">Clerk Login</h1>
          <p className="mt-2 text-[10px] font-black text-blue-400 uppercase tracking-[0.3em] relative z-10">Administrative Authentication</p>
        </div>
        ...
        {showOtpToast && (
          <div className="fixed top-6 right-6 z-[100] animate-in fade-in slide-in-from-top-4 duration-300">
            <div className="flex items-center gap-4 rounded-3xl border-2 border-amber-600 bg-white p-6 shadow-[0_30px_60px_-15px_rgba(217,119,6,0.2)] ring-8 ring-amber-600/5">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-amber-600">Official OTP</p>
        ...
        <div className="p-10 border-t border-slate-50">
          ...
          <form onSubmit={handleLogin} className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-100 bg-slate-50/50 pl-14 pr-4 py-5 text-xs font-bold text-navy focus:bg-white focus:ring-8 focus:ring-blue-600/5 focus:border-blue-600 focus:outline-none transition-all placeholder:text-slate-300 tracking-widest"
                  />
                </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="mt-4 flex w-full items-center justify-center gap-3 rounded-2xl bg-blue-600 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-[0_20px_40px_-10px_rgba(37,99,235,0.3)] transition-all hover:bg-blue-700 hover:shadow-[0_30px_60px_-10px_rgba(37,99,235,0.4)] hover:-translate-y-1 active:translate-y-0 disabled:opacity-70"
            >
              {isLoading ? (
          ...
          <div className="mt-10 border-t border-border pt-8 text-center text-[10px] font-bold text-muted/60 uppercase tracking-widest leading-relaxed">
             ...
             Governed by CyberShield Node Protocols
          </div>
        </div>
      </div>
    </div>
