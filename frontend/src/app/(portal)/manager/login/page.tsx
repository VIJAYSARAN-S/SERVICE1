    ...
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center p-4 bg-slate-50">
      <div className="w-full max-w-md overflow-hidden rounded-[32px] border border-border bg-white shadow-[0_40px_80px_-20px_rgba(15,23,42,0.15)]">
        <div className="bg-slate-50/50 p-10 text-center pb-8 border-b border-slate-100 relative">
          ...
          <h1 className="text-3xl font-black text-navy tracking-tight uppercase">Manager Login</h1>
          <p className="mt-2 text-xs font-black uppercase tracking-widest text-saffron bg-navy/5 inline-block px-3 py-1 rounded-lg">Directorate Authentication</p>
        </div>
              ...
              <div className="space-y-4">
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-slate-300 transition-colors group-focus-within:text-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-2xl border border-slate-100 bg-slate-50/50 pl-14 pr-4 py-5 text-xs font-black text-navy uppercase tracking-widest focus:bg-white focus:ring-8 focus:ring-navy/5 focus:border-navy focus:outline-none transition-all cursor-pointer"
                  >
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    disabled={!sector}
                    className="w-full rounded-2xl border border-slate-100 bg-slate-50/50 pl-14 pr-4 py-5 text-xs font-bold text-navy focus:bg-white focus:ring-8 focus:ring-slate-900/5 focus:border-slate-900 focus:outline-none transition-all placeholder:text-slate-300 tracking-widest disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
