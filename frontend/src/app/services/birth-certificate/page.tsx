...
export default function BirthCertificatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store success data to show on success page
  ...
  return (
    <div className="mx-auto max-w-3xl pb-20">
      <div className="mb-8">
        <h1 className="text-4xl font-extrabold tracking-tight text-navy">Apply for Birth Certificate</h1>
      ...
      <div className="rounded-2xl border border-border bg-white shadow-xl overflow-hidden">
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-muted mb-2">Parent/Guardian Full Name</label>
              <div className="relative">
                <span className="absolute left-4 top-3.5 text-muted/40 font-bold">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Legal name of father or mother"
                  className="w-full rounded-xl border border-border bg-background pl-11 pr-4 py-3 text-sm text-navy focus:border-primary focus:outline-none transition-all placeholder:text-muted/30"
                />
              </div>
            </div>
